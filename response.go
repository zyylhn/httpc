...
// GetHeaders method returns the response headers
...
func (r *Response) RawBody() io.ReadCloser {
	...
	if r.Request.notParseResponse || r.Request.client.notParseResponse {
...
func (r *Response) fmtBodyString(sl int64) string {
	if r.body != nil {
		...
		ct := r.GetHeaders().Get(hdrContentTypeKey)
		if IsJSONType(ct) {
			out := acquireBuffer()
